...
- [ ] Introduce stream predicate equality/entailment and a total Hoare judgment
...
- [ ] Prove identity/routing, consequence, sequential and parallel rules with
...
- [ ] Supply reusable predicates for equality to a full stream, equality of a
...
- [ ] Supply domain-aware derivative/integral and product contracts by reusing
...
- [ ] Restate `FormalHeat.circuit_behavior` as a total contract for the original
...
- [ ] Tests cover distinct port/axis counts, axes `[t,x]` and their transported
...
- [ ] `lake build` includes all new examples/regressions; an executable axiom
